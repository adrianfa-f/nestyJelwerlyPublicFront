...
import ProductStructuredData from "../componentes/ProductStructuredData";
...
const ProductDetail = () => {
  ...
  if (isLoading)
    return (
      <SEOWrapper
        title="Cargando producto... | Nesty Luxe Jewelry"
  ...
  return (
    <SEOWrapper
      title={`${product.name} | Nesty Luxe Jewelry`}
      description={
        product.description ||
        `Descubre ${product.name}. ${
          product.material ? `Fabricado en ${product.material}.` : ""
        } Precio: €${product.price}. Envío gratis.`
      }
      keywords={`${product.name}, ${product.category}, joyería, ${
        product.material || ""
      }, ${product.color || ""}`}
      image={product.image1 || "/images/product-default-og.jpg"}
      type="product"
    >
